...
//    public static Stack<DeliveryPartner> sortstack(Stack<DeliveryPartner> 
//                                             dp)
//    {
//        Stack<DeliveryPartner> tmpStack = new Stack<DeliveryPartner>();
//        while(!dp.isEmpty())
//        {
//            // pop out the first element
//            DeliveryPartner tmp = dp.pop();
//          
//            // while temporary stack is not empty and
//            // top of stack is greater than temp
//            while(!tmpStack.isEmpty() && ((DeliveryPartner) tmpStack).getRating().peek()> tmp)
//            {
//                // pop from temporary stack and 
//                // push it to the input stack
//            dp.push(tmpStack.pop());
//            }
//              
...
public class main {
//	private static void mergeSort(Stack<DeliveryPartner> dp, DeliveryPartner deliveryPartner,
//			DeliveryPartner deliveryPartner2) {
//		// TODO Auto-generated method stub
//		
//	}
//	public double comparator(DeliveryPartner a,DeliveryPartner b)
//	{
...
//	     System.out.println(d.getRating());
	...
	{
		//dp.forEach(DeliveryPartner-> System.out.println(DeliveryPartner));
	...
	public static void display1(Stack<DeliveryPartner> dp)
	{
      ...
      //SortbyRating s=new SortbyRating();
 ...
 //if(flag) {  
  ...
  System.out.println(delArray1[delArray1.length-1]);
	...
	//}
//	public static void display1(Stack<DeliveryPartner> dp,DeliveryPartner d)
//	{
//		dp.forEach(DeliveryPartner-> System.out.println(DeliveryPartner));
//		System.out.println(d.getRating());
//	}
...
//				Mozzarella m1=new Mozzarella();
//				double p1=220;
//				System.out.println("Cheese Mozzarella per pizza price is "+p1);
//				int w=m1.NumberOfPizza(p1);
//				
//				m1.cashonPay(p1,w);
